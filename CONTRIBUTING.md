# Contributing to @dhealth/qr-library

First off, thank you for considering contributing to @dhealth/qr-library.
It’s people like you that make @dhealth/qr-library such a great tool.

@dhealth/qr-library is an open source project and we love to receive contributions from
...
writing code which can be incorporated into @dhealth/qr-library itself.
...
If you think you have found a bug in @dhealth/qr-library, first make sure that you
are testing against the latest version of @dhealth/qr-library - your issue may already
...
If you find yourself wishing for a feature that doesn't exist in @dhealth/qr-library,
you are probably not alone. There are bound to be others out there with similar
needs. Many of the features that @dhealth/qr-library has today have been added because
our users saw the need. Open an [issue](github-issues) on our issues list on GitHub which describes
the feature you would like to see, why you need it, and how it should work.

## Contributing code and documentation changes

If you have a bugfix or new feature that you would like to contribute to @dhealth/qr-library, please find or open an issue
...
You will need to fork the main @dhealth/qr-library code repository and clone
...
Then sit back and wait. There will probably be discussion about the pull request and, if any changes are needed, we would love to work with you to get your pull request merged into @dhealth/qr-library.
...
[github-issues]:https://github.com/dhealthproject/qr-library/issues